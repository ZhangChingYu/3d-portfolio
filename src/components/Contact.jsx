...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setLoading(true)
    emailjs.send('service_fb1g27s', 'template_t0rv89o', {
      from_name: form.name,
      for_name: 'Silvia Chang',
      from_email: form.email,
      to_email: 'ccha0039@uni.sydney.edu.au',
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      className='flex-[0.8] bg-black-100 p-8 rounded-2xl'>
        <p className={`${styles.sectionSubText}`}>Gets in touch</p>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <button type='submit' className='bg-tertiary py-3 px-8 outlined-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl'>
