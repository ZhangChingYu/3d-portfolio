...
const FeedbackCard = ({ index, designation, company, name, image, testimonial }) => (
    ...
    <div className='mt-1'>
      ...
      <div className='mt-7 flex justify-between items-center gap-1'>
        <div className='flex-1 flex flex-col'>
          <p className='text-white text-medium text-[16px]'><span className='blue-text-gradient'>@</span>{name}</p>
